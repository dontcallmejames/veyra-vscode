...
export function extensionHostCheckLines({ afterLive = false } = {}) {
  return [
    ...
    '  6. If /debate does not end with "Gambit completed with errors.", continue with:',
    '     @gambit /review inspect this workspace and report risks only',
    '     @gambit /implement make a tiny test-only change, then review it',
    '  7. Confirm all-agent routing, read-only review/debate, write-capable implement, shared context, visible file edits, and edit-conflict surfacing.',
    ...
    '  read-only review/debate: pass/fail',
